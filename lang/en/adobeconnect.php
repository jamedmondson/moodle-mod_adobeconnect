...
$string['preventdelete'] = 'Prevent meeting deletion';
$string['preventdelete_desc'] = 'Do not delete meetings (and their recordings) off the Adobe Connect server when an activity is deleted. Prevents data loss when a course is deleted from the system for archiving, or backed up/restored from one system to another where it could be accidentally deleted. Warning: This can leave orphaned meetings on the server, and their meeting titles will not be able to be re-used within Moodle.';
